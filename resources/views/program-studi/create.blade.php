    ...
    <div class="py-10 form-wrap">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-extrabold text-gray-800">Tambah Unit/Prodi Baru</h1>
                    <p class="text-sm text-gray-400 mt-0.5">Isi detail program studi atau unit yang akan didaftarkan</p>
                </div>
            </div>
                ...
                <form action="{{ route('program-studi.store') }}" method="POST">
                    ...
                    <div class="p-6 md:p-8 space-y-6">
                        <div>
                            ...
                            <x-text-input id="nama_program_studi" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="nama_program_studi" :value="old('nama_program_studi')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="kode_program_studi" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="kode_program_studi" :value="old('kode_program_studi')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_kps" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="nama_kps" :value="old('nama_kps')" placeholder="Contoh: Dr. Eng. Fulan, S.T., M.T." />
                        ...
                        <div>
                            ...
                            <x-text-input id="nip_kps" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="nip_kps" :value="old('nip_kps')" placeholder="Contoh: 198001012005011001" />
