                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('program-studi.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nama_kps" class="block mt-1 w-full" type="text" name="nama_kps" :value="old('nama_kps')" placeholder="Contoh: Dr. Eng. Fulan, S.T., M.T." />
                            <x-input-error :messages="$errors->get('nama_kps')" class="mt-2" />
                        </div>
                        <div class="mt-4">
                            <x-input-label for="nip_kps" :value="__('NIP KPS')" />
                            <x-text-input id="nip_kps" class="block mt-1 w-full" type="text" name="nip_kps" :value="old('nip_kps')" placeholder="Contoh: 198001012005011001" />
