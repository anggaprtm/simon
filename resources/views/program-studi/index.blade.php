                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nama KPS</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">NIP KPS</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($programStudis as $prodi)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $prodi->nama_kps ?: '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $prodi->nip_kps ?: '-' }}</td>
