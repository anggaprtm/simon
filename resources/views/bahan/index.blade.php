                ...
                <form method="GET" action="{{ route('bahan.index') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                        <div class="md:col-span-3">
                            ...
                            <select name="prodi_id" class="select-input">
                        ...
                        <div class="md:col-span-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Kode, nama, merk, jenis..." class="search-input pl-9">
                            </div>
                        </div>
                        <div class="md:col-span-3 flex gap-2">
                            <button type="submit" class="top-btn bg-indigo-600 text-white flex-1 justify-center">
                            ...
                            <a href="{{ route('bahan.index') }}" class="top-btn bg-gray-100 text-gray-600 justify-center">Reset</a>
                        </div>
                    </div>
                    @else
                    <div class="flex flex-col md:flex-row gap-3 items-end">
                        ...
                        <div class="flex gap-2 shrink-0">
                            <button type="submit" class="top-btn bg-indigo-600 text-white">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"/></svg>
                                Cari
                            </button>
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody>
                                ...
                                <tr class="{{ $isKritis ? 'row-kritis' : 'row-normal' }}">
                                    ...
                                    <td>
                                        <div class="font-semibold text-gray-800 text-sm leading-tight">{!! $bahan->nama_bahan_html !!}</div>
                                        <div class="text-xs text-gray-400 mt-0.5">{{ $bahan->merk }}</div>
                                    </td>
                                    <td>
                                        @if($bahan->jenis_bahan)
                                        <span class="badge-jenis">{{ $bahan->jenis_bahan }}</span>
                                        @else
