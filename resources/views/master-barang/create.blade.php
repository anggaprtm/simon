                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('master-barang.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="spesifikasi" name="spesifikasi" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm">{{ old('spesifikasi') }}</textarea>
