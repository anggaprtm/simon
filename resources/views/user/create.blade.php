                    ...
                    <div class="p-6 md:p-8 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_lengkap" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="nama_lengkap" :value="old('nama_lengkap')" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="name" :value="old('name')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="email" name="email" :value="old('email')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="nik" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="nik" :value="old('nik')" />
                            ...
                            <div>
                                ...
                                <select id="role" name="role" class="block mt-1.5 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm transition-all text-sm" required onchange="toggleProdi()">
                                    ...
                                    <option value="kps" {{ old('role') == 'kps' ? 'selected' : '' }}>KPS (Koordinator Prodi)</option>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="password" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="password" name="password" required />
