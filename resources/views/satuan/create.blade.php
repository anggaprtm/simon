    ...
    <div class="py-10 form-wrap">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-5">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-extrabold text-gray-800">Tambah Satuan Baru</h1>
                    <p class="text-sm text-gray-400 mt-0.5">Daftarkan satuan takaran baru untuk bahan habis pakai</p>
                </div>
            </div>
                ...
                <form action="{{ route('satuan.store') }}" method="POST">
                    ...
                    <div class="p-6 md:p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_satuan" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="nama_satuan" :value="old('nama_satuan')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="keterangan_satuan" class="block mt-1.5 w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all" type="text" name="keterangan_satuan" :value="old('keterangan_satuan')" />
