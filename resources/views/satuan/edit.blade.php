                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('satuan.update', $satuan->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_satuan" class="block mt-1 w-full" type="text" name="nama_satuan" :value="old('nama_satuan', $satuan->nama_satuan)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="keterangan_satuan" class="block mt-1 w-full" type="text" name="keterangan_satuan" :value="old('keterangan_satuan', $satuan->keterangan_satuan)" />
